...
module.exports = function ShowSock({ user, sock }) {
  return (
        ...
        <div className="cst-wrapper">
            ...
            <div className="d-flex flex-wrap justify-content-center">
              <div className="d-flex">
                <div className="cst-generator-box">
                  <img className="cst-sock cst-color" src={`../${sock.color.link}`} alt="" />
                  {sock.pattern && (
                  <img className="cst-sock cst-pattern" src={`../${sock.pattern?.link}`} alt="" />
                  )}
                  {sock.image && (
                  <img className="cst-sock cst-image" src={`../${sock.image?.link}`} alt="" />
                  )}
                </div>
              </div>
            </div>
          ...
          <footer className="cst-footer">
            ...
            <div className="d-flex justify-content-center align-items-center">
              <div className="d-flex justify-content-center align-items-center cst-footer-icon">
            ...
            <div className="d-flex justify-content-center align-items-center">
              ...
              <div className="d-flex justify-content-center align-items-center">
                ...
                г. Москва, ш. Энтузиастов, д. 12, ст. 2
              </div>
            </div>
